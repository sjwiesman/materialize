...
To clean up the sources, views, and tables that we created, first connect to Materialize using a [PostgreSQL client](/interfaces/sql-clients/) and then, run the following commands:
...
Check out the [integrations page](/interfaces/) for a list of ORM frameworks
