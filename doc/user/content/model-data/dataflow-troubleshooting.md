...
and [`Transform data`](/model-data/troubleshooting/) troubleshooting guides,
...
pre-existing data. We recommend doing a [blue/green deployment](/operate/dbt/blue-green-deployments/)
