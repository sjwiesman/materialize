...
freshness](/model-data/monitor-freshness/).
...
- To investigate a high `local_lag`, use [Dataflow
  troubleshooting](/model-data/dataflow-troubleshooting/) to identify
...
troubleshooting](/model-data/dataflow-troubleshooting/). If possible,
