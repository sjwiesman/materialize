...
value](/model-data/idiomatic-materialize-sql/first-value/).
...
over](/model-data/idiomatic-materialize-sql/lag/).
...
group](/model-data/idiomatic-materialize-sql/last-value/).
...
over](/model-data/idiomatic-materialize-sql/lead/).
...
group](/model-data/idiomatic-materialize-sql/top-k/).
