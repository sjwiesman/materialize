...
[Optimization](/model-data/optimization/#query-hints).
...
[Appendix](/model-data/idiomatic-materialize-sql/appendix/example-orders).
...
- [Last value in a group](/model-data/idiomatic-materialize-sql/last-value)
- [`MIN()`](/sql/functions/#min)
- [`MAX()`](/sql/functions/#max)
- [Query hints for MIN/MAX](/model-data/optimization/#query-hints)
