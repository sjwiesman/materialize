...
{{< note >}}
See the guide on [partitioning and filter pushdown](/model-data/patterns/partition-by/) for a **private preview** feature that can make the filter pushdown optimization more predictable.
{{< /note >}}
