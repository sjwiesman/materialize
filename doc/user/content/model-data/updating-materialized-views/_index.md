...
|----------|-------------|-----------|
| [**Blue/green deployments**](/operate/dbt/blue-green-deployments/) | Complex changes across multiple objects, or when using dbt for deployment orchestration. | Ensures no impact to data freshness during cutover, but temporarily doubles resource usage and requires team coordination. |
...
For detailed instructions, see the [Blue/green deployment guide](/operate/dbt/blue-green-deployments/).
