...
aliases:
  - /model-data/tutorial-alter-mv/
  - /model-data/guide-alter-mv/
---
...
This guide uses a [three-tier cluster architecture](/operate/operational-guidelines/#three-tier-architecture),
