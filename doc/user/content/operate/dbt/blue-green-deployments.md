...
to use the [slim deployment pattern](/operate/dbt/slim-deployments/) instead for quicker
...
{{< warning >}}
If your dbt project includes [sinks](/operate/dbt/get-started/#sinks), you
...
1. Run the dbt project containing the code changes against the new deployment
   environment.
    ...
    You must [exclude sources and sinks](/operate/dbt/development-workflows/#exclude-sources-and-sinks) when running the dbt project.
