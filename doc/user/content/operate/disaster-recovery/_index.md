...
two-tier architecture](/operate/operational-guidelines/).
{{</ note >}}
...
architecture](/operate/operational-guidelines/). For details, see the [hybrid
...
- [Materialize DR
  characteristics](/operate/disaster-recovery/recovery-characteristics)
