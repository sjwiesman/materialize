...
options in full, see [How logs and metrics are stored](/operate/monitor/self-managed/storage/).
...
- [Honeycomb](/operate/monitor/self-managed/honeycomb/) and
  [OpenTelemetry](/operate/monitor/self-managed/opentelemetry/), which follow the
