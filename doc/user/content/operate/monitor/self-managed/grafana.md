...
aliases:
  - /operate/monitor/self-managed/prometheus/
menu:
  main:
    parent: "monitor-sm"
    weight: 3
...
stored](/operate/monitor/self-managed/storage/#how-it-works).
...
See [How logs and metrics are stored](/operate/monitor/self-managed/storage/#connect-existing-tooling).
...
stored](/operate/monitor/self-managed/storage/#sending-metrics-and-logs-elsewhere).
...
see [Alerting](/operate/monitor/self-managed/alerting/).
