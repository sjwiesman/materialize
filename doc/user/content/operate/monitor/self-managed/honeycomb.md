...
in [OpenTelemetry](/operate/monitor/self-managed/opentelemetry/). This page covers
...
metrics are stored](/operate/monitor/self-managed/storage/#how-it-works).

Honeycomb is an **additive** destination. It receives its own filtered copy of the
metrics, and the bundled [Thanos](/operate/monitor/self-managed/storage/),
...
thresholds in [Alerting](/operate/monitor/self-managed/alerting/).
...
[How logs and metrics are stored](/operate/monitor/self-managed/storage/).
...
- [OpenTelemetry](/operate/monitor/self-managed/opentelemetry/), for OTLP
  destinations generally, including bearer-token authentication and your own
  collector.

- [How logs and metrics are stored](/operate/monitor/self-managed/storage/), for the
