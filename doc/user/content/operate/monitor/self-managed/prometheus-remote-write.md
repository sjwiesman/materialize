...
destination](/operate/monitor/self-managed/opentelemetry/) instead, which runs
...
the metrics and thresholds in [Alerting](/operate/monitor/self-managed/alerting/).
...
- [OpenTelemetry](/operate/monitor/self-managed/opentelemetry/), the additive
