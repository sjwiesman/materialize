...
[Get started](/operate/mz-deploy/get-started/#prerequisites-and-installation).
...
| **[dbt](/operate/dbt/)** | Teams already invested in dbt. Manages views and materialized views. | No (clusters, connections, secrets are out of scope) | Yes (via `dbt-materialize` adapter macros) |
| **[Terraform](/operate/terraform/)** | Teams managing Materialize alongside other cloud infrastructure. | Yes | No |

## Available guides

{{< multilinkbox >}}
{{< linkbox title="To get started" >}}
[Get started with mz-deploy](/operate/mz-deploy/get-started/)
{{</ linkbox >}}
{{< linkbox title="Develop" >}}
- [Project structure](/operate/mz-deploy/project-structure/)
- [Infrastructure](/operate/mz-deploy/infrastructure/)
- [Local development](/operate/mz-deploy/local-development/)
- [Editor setup](/operate/mz-deploy/editor-setup/)
- [AI agent setup](/operate/mz-deploy/agent-setup/)
{{</ linkbox >}}
{{< linkbox title="Deploy" >}}
- [Deployments](/operate/mz-deploy/deployments/)
- [Stable APIs](/operate/mz-deploy/stable-apis/)
- [Profiles](/operate/mz-deploy/profiles/)
{{</ linkbox >}}
{{</ multilinkbox >}}
