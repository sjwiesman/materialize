...
[`compile`](/operate/mz-deploy/local-development/#compile-and-validate) and
[`test`](/operate/mz-deploy/local-development/#write-and-run-unit-tests) run
...
See [Stable APIs](/operate/mz-deploy/stable-apis/) for details.
