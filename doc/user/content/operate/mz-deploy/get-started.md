...
Docker is required for `mz-deploy test` and `mz-deploy explain` (see [Local development](/operate/mz-deploy/local-development/)).
...
[Project structure](/operate/mz-deploy/project-structure/) for full details.
...
mismatches. See [Local development](/operate/mz-deploy/local-development/) for
...
See [Deployments](/operate/mz-deploy/deployments/) for flags, error handling, and
deployment management.

## Next steps

- [Project structure](/operate/mz-deploy/project-structure/) — model files, companion statements, configuration
- [Infrastructure](/operate/mz-deploy/infrastructure/) — secrets, connections, sources, tables
- [Local development](/operate/mz-deploy/local-development/) — type checking, unit tests, query plans
- [Editor setup](/operate/mz-deploy/editor-setup/) — VS Code, Neovim, Helix integration
- [AI agent setup](/operate/mz-deploy/agent-setup/) — Claude Code, Codex, and other coding agents
- [Deployments](/operate/mz-deploy/deployments/) — staging, hydration, promotion, management
- [Stable APIs](/operate/mz-deploy/stable-apis/) — cross-team data products and data mesh
- [Profiles](/operate/mz-deploy/profiles/) — multi-environment configuration
