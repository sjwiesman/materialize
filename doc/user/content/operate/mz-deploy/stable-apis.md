...
Add `SET api = stable` to a [schema modifier](/operate/mz-deploy/project-structure/#schema-modifiers):
...
- Declares cross-project references as
  [external dependencies](/operate/mz-deploy/local-development/#external-dependencies)
  in `project.toml`.
