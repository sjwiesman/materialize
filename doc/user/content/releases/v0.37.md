...
* **Private preview.** Add a [WebSocket API endpoint](/interfaces/websocket-api/)
	which supports interactive SQL queries over WebSockets.

* Change the JSON serialization for rows emitted by the [HTTP API endpoint](/interfaces/http-api/)
