...
description: >
  ...
  mz-deploy across 10 modules and ~66 steps. Framed as a Middle-earth quest
  where the user is a Lorekeeper
...
If the result is ever non-empty, you have a violation. The companion MV participates in the full deployment pipeline — dependency tracking, blue/green, change detection — but it's hidden from the compiled output."
...
STEP 67: Summary and celebration.
...
8. **The Seal of Trust** — You verified constraints post-deployment
...
- Run `mz-deploy help --all` to discover advanced features
