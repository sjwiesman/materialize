...
//!
//! NOTE: The AST conversions mirror the server planner's private
//! `plan_auto_scaling_strategy` / `unplan_auto_scaling_strategy` in
//! `mz_sql::plan::statement::ddl`, which are the source of truth. A strategy
//! sub-policy added there needs a matching arm here.
