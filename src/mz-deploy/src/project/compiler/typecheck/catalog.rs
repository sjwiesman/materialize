...
use mz_repr::{
    CatalogItemId, GlobalId, RelationDesc, RelationVersion, RelationVersionSelector, SqlColumnType,
    SqlScalarType,
};
...
fn create_stub_table_sql(object_id: &ObjectId, columns: &BTreeMap<String, ColumnType>) -> String {
